...
/**
 * The tap-target detector, against real geometry (#488). From the 2026-09-07
 * nightly: 12 tap-target failures on the small-caps nav, measured nightly by
 * responsive-scorer.js and read by nothing. The small-copy detector that sat
 * beside it is `small-text-page.js` now, tested in small-text-dom.test.js.
 */
