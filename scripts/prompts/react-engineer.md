...
dashes, a period or a comma instead. An en dash is fine only between two
numbers with nothing around it (`2022–2025`, `3–1`); with a space on either
side, or next to a word, the gate reads it as a dash. An open range is written
in words: `2025 to present`, never `2025 – Present`. And the site never talks
about itself, so nothing about rebuilding,
